...
export const products = [
  {
    ...
    description:
      'Durable, weather-resistant PVC banner ideal for events, trade shows, storefronts, and outdoor advertising. Waterproof and UV-resistant for long-lasting vibrant colors.',
    ...
    materials: [
      {
        id: '13oz',
        label: '13oz PVC (Standard)',
        price: 0,
        description: 'Durable, waterproof, UV-resistant for indoor/outdoor use',
      },
      {
        id: '18oz',
        label: '18oz PVC (Heavy Duty)',
        price: 15,
        description: 'Extra thick for long-term outdoor display',
      },
      {
        id: 'mesh',
        label: 'PVC Mesh (Wind-Resistant)',
        price: 10,
        description: 'Micro-perforated for high-wind areas',
      },
    ],
    finishings: [
      ...
      {
        id: 'grommets',
        label: 'Grommets (Eyelets)',
        price: 0,
        description: 'Metal eyelets every 2ft for easy mounting',
      },
      {
        id: 'pole-pockets',
        label: 'Pole Pockets',
        price: 10,
        description: 'Sleeves for pole or rod mounting',
      },
      {
        id: 'wind-slits',
        label: 'Wind Slits',
        price: 5,
        description: 'Reduces wind resistance for outdoor use',
      },
    ],
    leadTimes: [
    ...
    materials: [
      {
        ...
        price: 0,
        description: 'Smooth, wrinkle-resistant',
      },
  ...
  },
  {
    ...
    description:
      'Micro-perforated PVC mesh banner (70% PVC, 30% air) for maximum wind resistance. Perfect for fences, scaffolding, and large outdoor displays.',
    image: null, // Placeholder - no image file yet
    ...
    materials: [
      {
        ...
        label: '9oz PVC Mesh',
        price: 0,
        description: 'Standard mesh with excellent airflow',
      },
      {
        id: '12oz',
        label: '12oz PVC Mesh (Heavy)',
        price: 15,
        description: 'Extra durability for long-term use',
      },
    ],
    finishings: [
      {
        ...
        label: 'Hemmed Edges',
        price: 0,
        description: 'Reinforced edges for durability',
      },
      {
        id: 'grommets',
        label: 'Grommets (Eyelets)',
        price: 0,
        description: 'Metal eyelets for secure mounting',
      },
    ],
    leadTimes: [
      { id: 'standard', label: 'Standard (5-7 days)', price: 0 },
    ...
    materials: [
      {
        ...
        price: 0,
        description: 'Vibrant colors, machine washable',
      },
