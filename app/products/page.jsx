  ...
  if (categorySlug && categorySlug !== 'all') {
    ...
    if (category) {
      return {
        ...
        description: category.description || `Browse our selection of ${category.name.toLowerCase()}. Made in Canada with fast shipping.`,
      };
    }
  }
    ...
    <div className="container py-8 md:py-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground">
          {currentCategory?.description || 'Select a size or start from a template. All banners made in Canada.'}
        </p>
      </div>
