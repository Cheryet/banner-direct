                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => addArrayItem('sizes', { label: '', price: 0 })}
                    >
                      <Plus className="mr-1 h-4 w-4" />
                      Add Size
                    </Button>
                      ...
                      {product.sizes.map((size, index) => (
                        ...
                        >
                          ...
                          <Input
                            value={size.label}
                            onChange={(e) =>
                              updateArrayItem('sizes', index, { label: e.target.value })
                            }
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        addArrayItem('materials', { label: '', price: 0, description: '' })
                      }
                    >
                      <Plus className="mr-1 h-4 w-4" />
                      Add Material
                            ...
                            <div className="flex-1 space-y-3">
                              <div className="flex gap-3">
                                <Input
                                  ...
                                  onChange={(e) =>
                                    updateArrayItem('materials', index, { label: e.target.value })
                                  }
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        addArrayItem('finishings', { label: '', price: 0, description: '' })
                      }
                    >
                      <Plus className="mr-1 h-4 w-4" />
                      Add Finishing
                        ...
                        <div key={finishing.id || index} className="rounded-lg border p-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 space-y-3">
                              <div className="flex gap-3">
                                <Input
                                  ...
                                  onChange={(e) =>
                                    updateArrayItem('finishings', index, { label: e.target.value })
                                  }
                                ...
                                <div className="relative w-32">
                                  ...
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      updateArrayItem('finishings', index, {
                                        price: parseFloat(e.target.value) || 0,
                                      })
                                    }
                                    className="pl-7"
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => removeArrayItem('finishings', index)}
                              className="text-red-600 hover:bg-red-50"
                            >
                              <X className="h-4 w-4" />
                            </Button>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => addArrayItem('lead_times', { label: '', price: 0, days: 5 })}
                    >
                      <Plus className="mr-1 h-4 w-4" />
                      Add Lead Time
                    </Button>
                      ...
                      {product.lead_times.map((lt, index) => (
                        ...
                        >
                          ...
                          <Input
                            value={lt.label}
                            onChange={(e) =>
                              updateArrayItem('lead_times', index, { label: e.target.value })
                            }
                          ...
                          <div className="w-20">
                            <Input
                              ...
                              value={lt.days}
                              onChange={(e) =>
                                updateArrayItem('lead_times', index, {
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => removeArrayItem('lead_times', index)}
                            className="text-red-600 hover:bg-red-50"
                          >
                            <X className="h-4 w-4" />
                          </Button>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setProduct({ ...product, shipping_weight: e.target.value })
                        }
                        placeholder="0.0"
                        className="mt-1"
                      />
                    ...
                    <div>
                      ...
                      <div className="relative mt-1">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setProduct({ ...product, free_shipping_threshold: e.target.value })
                          }
                          placeholder="150.00"
                          className="pl-7"
                        />
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Set quantity-based discounts</CardDescription>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() =>
                      addArrayItem('tier_pricing', { minQty: 1, maxQty: null, discount: 0 })
                    }
                  >
                    <Plus className="mr-1 h-4 w-4" />
                    Add Tier
                      ...
                      <div key={index} className="flex items-center gap-3 rounded-lg border p-3">
                        <div className="flex items-center gap-2">
                          <Input
                            ...
                            value={tier.minQty}
                            onChange={(e) =>
                              updateArrayItem('tier_pricing', index, {
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => removeArrayItem('tier_pricing', index)}
                          className="text-red-600 hover:bg-red-50"
                        >
                          <X className="h-4 w-4" />
                        </Button>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Additional services customers can add</CardDescription>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => addArrayItem('addons', { label: '', price: 0, description: '' })}
                  >
                    <Plus className="mr-1 h-4 w-4" />
                    Add Add-on
                  </Button>
                ...
                {product.addons.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="mt-1 text-xs text-gray-400">
                      Examples: Design proof, Rush processing, Gift wrapping
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                          ...
                          <div className="flex-1 space-y-3">
                            <div className="flex gap-3">
                              <Input
                                value={addon.label}
                                onChange={(e) =>
                                  updateArrayItem('addons', index, { label: e.target.value })
                                }
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                updateArrayItem('addons', index, { description: e.target.value })
                              }
                              placeholder="Description"
                            />
                          </div>
